...
Public Class DbAntrenor
    Public Shared Sub AddAntrenor(antrenor As Antrenor)
        Dim sql As String = "INSERT INTO ANTRENOR (ID_SALA, NUME, PRENUME, SALARIU) VALUES
    ...
    Public Shared Sub UpdateAntrenor(antrenor As Antrenor, id As String)
        Dim sql As String = "UPDATE ANTRENOR SET ID_SALA=@ID_SALA, NUME=@NUME, PRENUME=@PRENUME, SALARIU=@SALARIU
    ...
    Public Shared Sub Search(text As String, dgv As DataGridView)
        Dim sql As String = "SELECT ID_ANTRENOR, ID_SALA, NUME, PRENUME, SALARIU FROM ANTRENOR WHERE NUME LIKE '%" + text + "%'"
        Dim con As New SqlConnection
        Dim cmd As New SqlCommand
